...
Connects web scraper, query parser, and agents
"""
...
class DynamicInsuranceSearchEngine:
    """
    Main search engine integrating scraping, parsing, and agents
    ...
    def get_plan_details(self, plan_id: str) -> Optional[Dict]:
        ...
        """
        # Fetch fresh data and search for the plan
        plans = self._fetch_plans()
...
def get_search_engine() -> DynamicInsuranceSearchEngine:
    """Get or create global search engine instance"""
    global _search_engine
    if _search_engine is None:
        _search_engine = DynamicInsuranceSearchEngine()
